...
public class DoMahout {
	public static void main(String args[]){
		try{
			...
			//			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("/Users/kaderchowdhury/University/Project/data/user_recommendations.csv"))));
...
//			for(int i=1;i<=10;i++){
				...
				for (RecommendedItem recommendation : recommendations) {
					...
					//					writer.append(i+","+recommendation.getItemID()+","+recommendation.getValue());
					//					writer.append("\n");
				}
//			}
			//			writer.flush();
