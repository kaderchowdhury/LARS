...
public class LocationOverlayMapViewer extends DownloadLayerViewer {
    ...
    protected void createLayers() {
        ...
        Drawable drawable = Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.marker_red) : getResources().getDrawable(R.drawable.marker_red);
