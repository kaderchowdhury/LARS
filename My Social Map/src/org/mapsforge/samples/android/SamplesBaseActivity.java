...
public abstract class SamplesBaseActivity extends MapViewerTemplateRuntimePermissions implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final LatLong LATLONG_COVENTRY = new LatLong(52.407999, -1.505722);
    public static final LatLong LATLONG_LONDON = new LatLong(51.6704834, -0.0407202);
    ...
    protected MapPosition getDefaultInitialPosition() {
        return new MapPosition(LATLONG_COVENTRY, (byte) 12);
    }
    ...
    protected void createMapViews() {
        ...
        changePosition(LATLONG_LONDON);
    }
    
    public void changePosition(LatLong latlong){
    	byte zoomLevel = (byte) ((25) +
        ...
        SamplesBaseActivity.this.mapView.getModel().mapViewPosition.setMapPosition(
                new MapPosition(latlong, zoomLevel));
    }
