...
public class BubbleOverlay extends RenderTheme4 {
    ...
    protected void createLayers() {
        ...
        for (DummyContent.DummyItem item : DummyContent.ITEMS) {
            ...
            Utils.setBackground(bubbleView, Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.balloon_overlay_unfocused) : getResources().getDrawable(R.drawable.balloon_overlay_unfocused));
