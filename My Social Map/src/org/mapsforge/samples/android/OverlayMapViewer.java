...
public class OverlayMapViewer extends RenderTheme4 {
    ...
    protected void addOverlayLayers(Layers layers) {
        ...
        shaderPaint.setBitmapShader(AndroidGraphicFactory.convertToBitmap(Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.marker_green) : getResources().getDrawable(R.drawable.marker_green)));
        ...
        Paint paintFill2 = Utils.createPaint(
                AndroidGraphicFactory.INSTANCE.createColor(Color.GREEN), 2,
                Style.FILL);
        paintFill2.setBitmapShader(AndroidGraphicFactory.convertToBitmap(Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.marker_green) : getResources().getDrawable(R.drawable.marker_green)));
        ...
        Paint paintFill3 = Utils.createPaint(
                ...
                Style.FILL);
        paintFill3.setBitmapShader(AndroidGraphicFactory.convertToBitmap(Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.marker_red) : getResources().getDrawable(R.drawable.marker_red)));
