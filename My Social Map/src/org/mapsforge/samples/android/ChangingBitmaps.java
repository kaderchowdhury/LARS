...
public class ChangingBitmaps extends RenderTheme4 {
    ...
    public void onCreate(Bundle sis) {
        Drawable drawableWhite = Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUR_DEVELOPMENT ? getResources().getDrawable(R.drawable.marker_white) : getResources().getDrawable(R.drawable.marker_white);
